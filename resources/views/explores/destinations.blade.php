...
<head>
    ...
    <title>Destinations - Wonderful Indonesia</title>
    @vite(['resources/css/explore/app.css', 'resources/js/destination/app.js'])
</head>
<body class="bg-gray-50">
    ...
    <!-- Main Content -->
    <div class="pt-16 pb-12" x-data="destinations" x-init="init()">
        <!-- Hero Section -->
        <div class="relative bg-gradient-to-r from-blue-600 to-teal-500 h-[300px] mb-12">
            <div class="absolute inset-0 bg-black/30"></div>
            <div class="relative container mx-auto px-4 h-full flex flex-col justify-center">
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">Explore Indonesian Destinations</h1>
                <p class="text-xl text-white/90 max-w-2xl">Discover the breathtaking beauty of Indonesia's diverse landscapes, rich culture, and unforgettable experiences.</p>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-12 transition-all duration-300 hover:shadow-xl space-y-6">
                <!-- Search Input -->
                <div class="relative">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Search Destinations</label>
                    <div class="relative">
                        <input 
                            type="text" 
                            x-model="searchQuery"
                            ...
                            class="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300"
                        >
            ...
            <!-- No Results State -->
            <div x-show="filteredDestinations.length === 0 && !loading" class="text-center py-12">
            ...
            <!-- Destinations Grid -->
            <div x-show="filteredDestinations.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                <template x-for="destination in filteredDestinations" :key="destination['destination-name']">
                        ...
                        <div class="relative overflow-hidden rounded-2xl shadow-lg aspect-[4/3] bg-gray-100">
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div class="absolute bottom-0 left-0 right-0 p-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                    <h3 class="text-white text-xl font-bold mb-2" x-text="destination['destination-name']"></h3>
                                    <p class="text-gray-200 text-sm flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                                        </svg>
                                        <span x-text="destination.provinsi"></span>
                                    </p>
                                </div>
                            </div>
                        </div>
