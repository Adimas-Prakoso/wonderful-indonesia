...
<head>
    ...
    <title>Traditional House Information - Wonderful Indonesia</title>
    @vite(['resources/css/house-info/app.css', 'resources/js/house-info/app.js'])
</head>
<body class="bg-gray-50">
    ...
    <!-- Main Content -->
    <div class="pt-16 pb-12" x-data="houseInfo" x-init="init()">
        <!-- Hero Section -->
        <div class="relative h-[400px] mb-12">
            ...
            <div class="relative container mx-auto px-4 h-full flex flex-col justify-end pb-12">
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-4" x-text="houseName"></h1>
                <p class="text-xl text-white/90 max-w-2xl" x-text="'Traditional House from ' + origin"></p>
            </div>
        </div>
            ...
            <div x-show="!loading" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-3 space-y-8">
                    ...
                    <section class="bg-white rounded-2xl shadow-lg p-8">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Uniqueness</h2>
                        <div class="prose prose-lg max-w-none" x-html="uniqueness"></div>
                    </section>

                    <!-- Function Section -->
                    <section class="bg-white rounded-2xl shadow-lg p-8">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Functions</h2>
                        <div class="prose prose-lg max-w-none" x-html="houseFunction"></div>
                    </section>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <template x-for="(image, index) in gallery" :key="index">
                                <div class="relative aspect-[4/3] rounded-xl overflow-hidden cursor-pointer group" @click="openLightbox(index)">
                                    <img 
                                        :src="image" 
                                        :alt="houseName + ' gallery image ' + (index + 1)"
        ...
        <div x-show="lightboxOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black/90" @click="closeLightbox">
            ...
            <img 
                ...
                :alt="houseName + ' gallery image ' + (currentImageIndex + 1)"
